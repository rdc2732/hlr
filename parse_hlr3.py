...
# this will be the sqlite version
...
cur.execute("CREATE TABLE Modules (mod_id INT PRIMARY KEY, mod_name TEXT)")
cur.execute("CREATE TABLE Signals (sig_id INT PRIMARY KEY, sig_name TEXT)")
cur.execute("CREATE TABLE ModSigs (mod_sig_type TEXT, mod_id INT, sig_id INT, \
